...
class Value extends Component {
    render() {
        ...
        ">
          ...
          <img className="u-image u-image-default u-image-1" data-image-width={1200} data-image-height={800} src="images/gfggg-min.jpg" data-animation-name="pulse" data-animation-duration={1000} data-animation-delay={0} data-animation-direction />
          <div className="
          ...
          " data-animation-name="fadeIn" data-animation-duration={1000} data-animation-delay={0} data-animation-direction>
            <div className="u-container-layout u-container-layout-1">
              <h5 className="u-text u-text-1">Leadership, Innovation</h5>
              <h1 className="u-text u-text-2">The Innovative Technology Leader</h1>
            </div>
          </div>
          <div className="
            u-expanded-width-lg
